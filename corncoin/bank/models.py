...
class Market(models.Model):
    ...
    mining_code = models.CharField(max_length=255, blank=True)  # Stores encrypted 3-digit code
    ...
    def generate_new_code(self):
        ...
        new_code = "{:03d}".format(random.randint(0, 999))  # Ensures 3 digits (e.g., 001, 123)
